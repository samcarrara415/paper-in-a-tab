...
cp api-52-all.jar jvmdg-patched.jar shade-asm.jar launcher26/launcher26.jar jfr-stub/jfr-stub.jar "$OUT/"
...
head = ['launcher26.jar', 'jfr-stub.jar', 'api-52-all.jar', 'jvmdg-patched.jar', 'shade-asm.jar', 'paper-26.2.jar']
